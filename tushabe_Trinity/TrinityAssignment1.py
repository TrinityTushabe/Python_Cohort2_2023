'''
Introducining a conditional function with if loop function to display a workers Paye 
The function prompts the workers to enter their year of birth, name , occupation and location
And it prints the results if the eligbe to be taxed or not
'''
